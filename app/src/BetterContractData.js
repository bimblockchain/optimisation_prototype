...
class BetterContractData extends Component {
...
BetterContractData.contextTypes = {
  drizzle: PropTypes.object,
};

BetterContractData.propTypes = {
...
export default drizzleConnect(BetterContractData, mapStateToProps);
